...
echo "<tr bgcolor='#e3e3e3'><th rowspan='16' width='110px'><center><img style='border:1px solid #cecece; height:85px; width:85px' src='" . base_url() . "asset/foto_user/$foto_user' class='img-circle img-thumbnail'></center></th></tr>
...
echo "</td></tr>";
//  echo " <tr><th scope='row'>Ganti Foto KTP</th>                         <td><input type='file' class='form-control' name='gg'></td></tr>";
  echo " <tr><th scope='row'>Ganti Foto KTP</th><td><input type='file' class='form-control' name='hh'>";
  if ($rows['foto_ktp'] != '') {
    echo "<i style='color:red'>Foto Profile saat ini : </i><a target='_BLANK' href='" . base_url() . "asset/foto_user/$rows[foto_ktp]'>$rows[foto_ktp]</a>";
  }
  echo "</td></tr>";
  echo " <tr><th scope='row'>Ganti Foto QRIS</th><td><input type='file' class='form-control' name='ii'>";
  if ($rows['foto_qris'] != '') {
    echo "<i style='color:red'>Foto Profile saat ini : </i><a target='_BLANK' href='" . base_url() . "asset/foto_user/$rows[foto_qris]'>$rows[foto_qris]</a>";
  }
  echo "</td></tr>";
