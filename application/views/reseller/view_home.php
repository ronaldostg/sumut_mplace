              ...
              <div class="box box-info">
                ...
                <h3 class="box-title">Selamat datang Reseller!</h3>
                  ...
                  Silahkan mengelola Semua data melalui menu yang sudah kita sediakan dibelah kiri anda, berikut data profile anda : <br><br>
                   ...
                   <a href="#" class="btn btn-warning button-disabled btn-lg">
                    <span class="glyphicon glyphicon-warning-sign"></span> <p>Mohon lengkapi data anda untuk proses validasi</p> 
                  </a>
                   ...
                   <?php 
                      ...
                      <dl class="dl-horizontal">
                          ...
                          <dt>Foto ktp</dt>   <dd> <?php echo "<img src='".base_url()."asset/foto_user/".$rows['foto_ktp']."' style='width:75%;heigh: 75%;%'>"?></p></dd>
                          <dt>Foto QRIS</dt>   <dd> <?php echo "<img src='".base_url()."asset/foto_user/".$rows['foto_qris']."' style='width:75%;heigh: 75%;%'>"?></p></dd>
                      </dl>
                    <hr style='margin:7px'>
