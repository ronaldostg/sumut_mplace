...
class Reseller extends CI_Controller {
	...
	function upload_photos($path,$uploadField){
	...
	function edit_reseller(){
		...
		if (isset($_POST['submit'])){
			$hasil = $this->upload_photos('asset/foto_user/','gg');
			$hasil2 = $this->upload_photos('asset/foto_ktp_reseller/','hh');
			$hasil3 = $this->upload_photos('asset/qris_seller/','ii');
			...
			// $config2['upload_path'] = 'asset/foto_ktp_reseller/';
            // $config2['allowed_types'] = 'gif|jpg|png|jpeg';
            // $config2['max_size'] = '5000'; // kb
            // $this->load->library('upload', $config2);


			// $config3['upload_path'] = 'asset/foto_qris_seller/';
            // $config3['allowed_types'] = 'gif|jpg|png|jpeg';
            // $config3['max_size'] = '5000'; // kb
            ...
            // $this->upload->do_upload('hh');
            // $this->upload->do_upload('ii');
            ...
            if ($hasil['file_name']==''){
				if (trim($this->input->post('b')) != ''){
		            $data = array('password'=>hash("sha512", md5($this->input->post('b'))),
								...
								'foto_ktp'=>$hasil2['file_name'],
		                        'foto_qris'=>$hasil3['file_name'],
